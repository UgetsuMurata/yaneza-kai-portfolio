  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 h-screen relative">
        ...
        <div className="w-full aspect-square custom-glow-shadow absolute top-1/2 -translate-y-1/2 z-0 bg-radial-[at_50%_25%] from-primary to-primary-dark-900 from-35% rounded-4xl" />
      </div>
